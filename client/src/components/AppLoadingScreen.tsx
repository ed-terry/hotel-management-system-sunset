...
const AppLoadingScreen: React.FC<AppLoadingScreenProps> = ({ onLoadingComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-primary via-accent to-secondary z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 text-center max-w-md mx-auto px-6">
        {/* Logo */}
        <div className="mb-8">
          <div className="mx-auto h-28 w-28 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mb-6 shadow-2xl border border-white/30 animate-pulse p-2">
            <Logo size={96} className="rounded-2xl shadow-xl" />
          </div>
          <h1 className="text-4xl font-bold text-white mb-2 drop-shadow-lg">Sunset Hotel</h1>
        ...
        <div className="mb-8">
          {isComplete ? (
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-white text-xl font-semibold">Welcome!</p>
            </div>
          ) : (
            <LoadingSpinner 
              size="xl" 
        ...
        <div className="space-y-4">
          <div className="w-full bg-white/20 rounded-full h-2 backdrop-blur-sm">
            <div 
              className="h-2 bg-gradient-to-r from-white to-white/80 rounded-full transition-all duration-500 ease-out shadow-lg"
